  ...
  return {
    ...
    bilateralEnhancedProbes: {
      ...
      dimensions: result.enhanced.dimensions.map(dimension => ({
        ...
        canvastPassedRepeats: dimension.canvast.passedRepeats,
        canvastTotalRepeats: dimension.canvast.totalRepeats,
        referenceStatus: dimension.reference.status,
        referencePassedRepeats: dimension.reference.passedRepeats,
        referenceTotalRepeats: dimension.reference.totalRepeats,
